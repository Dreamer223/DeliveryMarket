package ru.dreamer.deliverymarket.security;
...
class OAuthClientHttpRequestInterceptorTest {
    ...
    @BeforeEach
    void setUp() {
        this.interceptor = new OAuth2Client(this.authorizedClientManager, "test");
    }
    ...
    void intercept_AuthorizationHeaderIsNotSet_AddsAuthorizationHeader() throws IOException {
        ...
        var authorizedClient = new OAuth2AuthorizedClient(mock(), "manager",
