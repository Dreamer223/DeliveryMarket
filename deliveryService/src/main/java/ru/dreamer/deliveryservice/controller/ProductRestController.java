...
import ru.dreamer.deliveryservice.controller.payload.UpdateProductPayload;
...
@RequestMapping("/api/products/{id:\\d+}")
public class ProductRestController {
    ...
    public ResponseEntity<Product> updateProduct(@PathVariable("id") Long id,
        ...
        if (bindingResult.hasErrors()){
            ...
            this.productService.update(id, payload.name(), payload.category(), payload.description(), payload.price());
